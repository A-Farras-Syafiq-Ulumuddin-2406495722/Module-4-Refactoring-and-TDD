...
public class OrderServiceImplTest {
    ...
    void testUpdateStatusInvalidOrderId() {
        doReturn(null).when(orderRepository).findById("king acid, farrel");

        assertThrows(NoSuchElementException.class,
                () -> orderService.updateStatus("king acid, farrel", OrderStatus.SUCCESS.getValue()));
    ...
    void testFindByIdIfIdNotFound() {
        doReturn(null).when(orderRepository).findById("alin");
        assertNull(orderService.findById("alin"));
    }
